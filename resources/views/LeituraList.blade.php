...
<body style="background-image: url(/img/background.jpg)">
    ...
    <div class="container">
       <h1>Listagem de Usuários {{ request()->id }}</h1>
        <form action="{{ action('App\Http\Controllers\LeituraController@search') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-6">
                    ...
                    <a class="btn btn-success"
                        href="{{ action('App\Http\Controllers\LeituraController@create') }}"><i
